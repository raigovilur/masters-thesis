...
def generate_latency_graph(throughput_logfile_name_list, protocol_name_list):
    
    latency_fig = go.Figure()
    x_min, x_max = 1000000, 0
    y_min, y_max = 1000000, 0
    for latency_logfile_name, protocol_name in zip(latency_logfile_name_list, protocol_name_list):
        ...
        print(f"Packet Loss : {i / RECORD_NUM}")
        ...
        latency_fig.add_trace(go.Scatter(x=latency_df["rate"], y=latency_df["latency"], name=protocol_name))
...
if __name__ == "__main__":
    ...
    #client_dirlist = ["2021-08-26-11_30_14", "2021-08-26-11_51_52", "2021-08-26-12_09_11"]
    #server_dirlist = ["2021-08-26-11:30:07", "2021-08-26-11:51:32", "2021-08-26-12:08:52"]
    #protocol_name_list = ["TLS", "DTLS", "QUIC"]
    
    # TLS_AES_256_GCM_SHA256
    #client_dirlist = ["2021-08-26-11_34_47", "2021-08-26-11_55_28", "2021-08-26-12_12_43"]
    #server_dirlist = ["2021-08-26-11:34:08", "2021-08-26-11:55:12", "2021-08-26-12:12:35"]
    #protocol_name_list = ["TLS", "DTLS", "QUIC"]
    
    # TLS_AES_128_CCM_SHA256
    #client_dirlist = ["2021-08-26-11_39_05", "2021-08-26-11_58_41"]
    #server_dirlist = ["2021-08-26-11:38:51", "2021-08-26-11:58:32"]
    #protocol_name_list = ["TLS", "DTLS"]
    
    # TLS_AES_128_CCM_8_SHA256
    #client_dirlist = ["2021-08-26-11_43_59", "2021-08-26-12_02_17"]
    #server_dirlist = ["2021-08-26-11:43:38", "2021-08-26-12:02:08"]
    #protocol_name_list = ["TLS", "DTLS"]
    
    # TLS_CHACHA20_POLY1305_SHA256
    client_dirlist = ["2021-08-26-11_47_14", "2021-08-26-12_05_34", "2021-08-26-12_16_15"]
    server_dirlist = ["2021-08-26-11:47:06", "2021-08-26-12:05:24", "2021-08-26-12:16:03"]
    protocol_name_list = ["TLS", "DTLS", "QUIC"]
    ...
    generate_latency_graph(latency_logfile_name_list, protocol_name_list)
